...
import { getCourseBySlug, getAllCourses, sanitizeHtml } from "@/lib/wordpress"
            ...
            <div>
              ...
              <TextReveal delay={0.2}>
                <div
                  ...
                  dangerouslySetInnerHTML={{ __html: sanitizeHtml(course.excerpt.rendered) }}
                />
              </TextReveal>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="md:col-span-2">
              ...
              <div
                ...
                dangerouslySetInnerHTML={{ __html: sanitizeHtml(course.content.rendered) }}
              />
